  ...
  <div class="error-page onepage-screen-area">
    <div class="container-fluid">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div
            class="animate__animated slideInUp"
          ...
          >
            <div class="content">
              ...
              <p class="mt-5">
                Explore our <a href="/services">services</a> or
        ...
        <div class="col-lg-6">
          <div class="animate__animated zoomIn" style="animation-duration: 1s">
            <div class="thumbnail">
    ...
    <ul class="shape-group-breadcrum-1 list-unstyled">
      <li class="shape shape-1">
        <img src="../assets/img/shapes/bubble-9.png" alt="Bubble" />
      </li>
      <li class="shape shape-4">
        <img src="../assets/img/shapes/bubble-27.png" alt="Bubble" />
      </li>
