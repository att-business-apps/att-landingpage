        ...
        <div class="col-lg-10">
          <div class="privacy-policy-content">
            ...
            <ul>
              ...
              <li>To improve our website and services by analyzing how users interact with our site.</li>
              <li>To communicate with you, including sending you updates, promotional materials, and responding to your
                inquiries.</li>
              <li>To process transactions and provide customer support.</li>
              <li>To ensure the security of our website and protect against unauthorized access.</li>
            </ul>

            <h2>3. Cookies and Tracking Technologies</h2>
            <p>We use cookies and similar tracking technologies to enhance your experience on our website. Cookies are
              small data files stored on your device that help us understand your preferences and improve our services.
              You can choose to disable cookies through your browser settings, but this may limit your ability to use
