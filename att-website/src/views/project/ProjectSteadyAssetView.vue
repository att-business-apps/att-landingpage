<template>
    ...
    <section class="section section-padding">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="project-overview">
                        ...
                        <p class="mb-4">
                            <strong>SteadyAsset (steadyasset.com)</strong> offers fixed-income products and fractional
                            commercial real estate to retail and HNI investors. We delivered a coherent brand system and
                            an intuitive website that communicates trust, security, and accessibility.
                        </p>
                        <div class="project-details">
                            <div class="detail-item mb-3">
                                <h5 class="title">Client</h5>
                                <p>SteadyAsset Investment Platform</p>
                            </div>
                            <div class="detail-item mb-3">
                            ...
                            <div class="detail-item mb-3">
                                ...
                                <p>Modern Web Technologies, Responsive Design</p>
                            </div>
                            <div class="detail-item">
                                <h5 class="title">Live Website</h5>
                                <p><a href="https://steadyasset.com" target="_blank"
                                        class="text-primary">steadyasset.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="project-image">
                        <img src="../../assets/img/project/c4/project-sa.png" class="w-100 rounded"
                            alt="SteadyAsset Website Design and Development">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    <img src="../../assets/img/project/c4/sa-mockup.png" class="img-fluid rounded mt-5"
                        alt="SteadyAsset Project">
                </div>
            </div>
        </div>
    </section>
