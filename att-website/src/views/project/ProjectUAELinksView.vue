...
const heroMockup = new URL("../../assets/img/project/c1/project-uaeLinks.png", import.meta.url).href;
const clientLogo = new URL("../../assets/img/project/c1/icon-uae.svg", import.meta.url).href;
const mobileMockup = new URL("../../assets/img/project/c1/project-uae-mob.png", import.meta.url).href;
const compareLight = new URL("../../assets/img/project/c1/uae-li.png", import.meta.url).href;
const compareDark = new URL("../../assets/img/project/c1/uae-dr.png", import.meta.url).href;

const metrics = [
  { value: "1", label: "Unified portal for all UAE services" },
  { value: "6+", label: "Government service categories" },
  { value: "100%", label: "Mobile-responsive coverage" },
  { value: "↓", label: "Time-to-find for key services" },
  { value: "GA4", label: "Tracking live from launch day" },
  { value: "0", label: "Logins required to browse services" },
];
...
const outcomes = [
  { icon: "hub", title: "One trusted starting point", desc: "Users now have a single, recognisable gateway instead of guessing which government site to search for." },
  { icon: "bolt", title: "Faster task completion", desc: "Clear categories and minimal clicks mean less time spent navigating, more time spent on the actual task." },
  { icon: "devices", title: "Consistent on every device", desc: "The mobile-first build means the experience holds up whether someone arrives on a desktop or a phone." },
  { icon: "monitoring", title: "Measurable from day one", desc: "GA4 tracking shows exactly which categories get used most, guiding what gets prioritised next." },
  { icon: "settings_suggest", title: "Built to expand", desc: "The information architecture was designed to absorb new service categories without a structural rebuild." },
  { icon: "forum", title: "A reference for public-sector UX", desc: "UAE Links is now a live example of how government services can be presented simply, without bureaucratic clutter.", highlight: true },
];
...
<template>
  ...
  <section class="cs-hero">
    ...
    <div class="cs-shell">
      ...
      <div class="cs-hero-eyebrow">
        <span class="eyebrow-pill">UAE Govt Portal</span>
        Government Services Portal &middot; 2024
      </div>

      <h1 class="cs-hero-title">
        <span class="cs-line">UAE Links</span>
      </h1>
      ...
      <div class="cs-hero-split">
        ...
        <div class="cs-hero-stats">
          <div class="cs-hero-stat">
            <span class="cs-hero-stat-val">6+</span>
            <span class="cs-hero-stat-label">Categories</span>
          </div>
          <div class="cs-hero-stat-divider"></div>
          <div class="cs-hero-stat">
            <span class="cs-hero-stat-val">100%</span>
            <span class="cs-hero-stat-label">Mobile-ready</span>
          </div>
          <div class="cs-hero-stat-divider"></div>
          <div class="cs-hero-stat">
            <span class="cs-hero-stat-val">1</span>
            <span class="cs-hero-stat-label">Trusted gateway</span>
          </div>
        </div>
      </div>

      <div class="cs-hero-ctas">
        <a href="https://uaelinks.ae" target="_blank" rel="noopener" class="cs-btn-primary">
          Visit Live Site
      ...
      <div class="cs-hero-mockup-wrap">
        <div class="cs-hero-mockup">
          <img :src="heroMockup" alt="UAE Links portal on desktop" loading="lazy" />
        </div>
  ...
  <section class="cs-meta-strip">
    <div class="cs-shell cs-meta-grid">
      <div class="cs-meta-item">
        ...
        <span class="cs-meta-value">UAE Government Services Portal</span>
      </div>
      <div class="cs-meta-item">
        <span class="cs-meta-label">Industry</span>
        <span class="cs-meta-value">Public Sector / Government Services</span>
      </div>
      <div class="cs-meta-item">
        <span class="cs-meta-label">Engagement</span>
        <span class="cs-meta-value">UX Research &middot; UI Design &middot; Web Dev &middot; Analytics</span>
      </div>
      <div class="cs-meta-item">
        <span class="cs-meta-label">Live Site</span>
        <span class="cs-meta-value">
          <a href="https://uaelinks.ae" target="_blank" rel="noopener" class="cs-meta-link">uaelinks.ae</a>
        </span>
      </div>
    </div>
  </section>
    ...
    <div class="cs-shell">
      <div class="cs-section-head cs-reveal">
        ...
        <div>
          ...
          <h2 class="cs-h2">What is UAE Links?</h2>
        </div>
      </div>
      ...
      <div class="cs-client-grid cs-reveal">
        <div class="cs-client-copy">
          ...
          <p>
            ...
            service they needed and search for that portal individually. The goal was simple:
            one clear, trustworthy starting point for any government-related task.
          </p>

          <div class="cs-fact-list">
            <div class="cs-fact">
              <span class="material-symbols-outlined">account_balance</span>
              <div><strong>Sector</strong><span>Public Sector / Government Services</span></div>
            </div>
            <div class="cs-fact">
              <span class="material-symbols-outlined">group</span>
              <div><strong>Audience</strong><span>Residents, workers &amp; visitors in the UAE</span></div>
            </div>
            <div class="cs-fact">
            ...
            <div class="cs-fact">
              ...
              <div><strong>Website</strong><a href="https://uaelinks.ae" target="_blank" rel="noopener">uaelinks.ae</a></div>
            </div>
          </div>
        </div>

        <aside class="cs-client-card">
          <img :src="clientLogo" alt="UAE Links logo" class="cs-client-logo" loading="lazy" />
          <span class="cs-quote-mark material-symbols-outlined">format_quote</span>
          <p class="cs-client-quote">
            Government services shouldn't require a search engine just to find the right
            portal. One trusted hub, clearly organised, was the whole point.
          </p>
          <div class="cs-client-quote-attr">Project Brief, UAE Links</div>
        </aside>
      </div>
    </div>
  </section>
    ...
    <div class="cs-shell">
      <div class="cs-section-head cs-reveal">
        ...
        <div>
          ...
          <h2 class="cs-h2 cs-h2--light">Why a unified portal was overdue</h2>
        </div>
      </div>
    ...
    <div class="cs-shell">
      <div class="cs-section-head cs-reveal">
        ...
        <div>
          ...
          <h2 class="cs-h2">Clarity first, decoration second</h2>
        </div>
      </div>
    ...
    <div class="cs-shell">
      <div class="cs-section-head cs-reveal">
        ...
        <div>
          ...
          <h2 class="cs-h2">Research to launch</h2>
        </div>
      </div>
    ...
    <div class="cs-shell">
      <div class="cs-section-head cs-reveal">
        ...
        <div>
          ...
          <h2 class="cs-h2">Light &amp; dark, side by side</h2>
          <p class="cs-section-sub">Drag to compare the light and dark interface treatments built for the portal.</p>
        </div>
      </div>

      <div class="cs-compare-wrap cs-reveal">
        <VueCompareImage :left-image="compareLight" :right-image="compareDark" />
      </div>

      <div class="cs-mockup-wrap cs-reveal">
        <img :src="mobileMockup" alt="UAE Links mobile view" loading="lazy" />
      </div>
    </div>
  </section>
    ...
    <div class="cs-shell">
      <div class="cs-section-head cs-reveal">
        ...
        <div>
          ...
          <h2 class="cs-h2 cs-h2--light">What the portal delivers</h2>
          <p class="cs-section-sub cs-section-sub--light">The structural and experience wins that came out of the rebuild.</p>
        </div>
      </div>
    ...
    <div class="cs-shell">
      <div class="cs-section-head cs-reveal">
        ...
        <div>
          ...
          <h2 class="cs-h2">What this built for UAE Links</h2>
        </div>
      </div>
      ...
      <div class="cs-nav-row cs-reveal">
        <a href="/about" class="cs-nav-link">
          <span class="material-symbols-outlined">arrow_back</span> Our Journey
        </a>
  ...
  <CaseStudyWorkWithUs
    ...
    :services="['UX Research', 'Portal UI Design', 'Responsive Website', 'Google Analytics']"
...
.cs-hero-mockup {
  ...
  border-bottom: none;
  box-shadow: 0 -20px 100px rgba(22,163,74,0.08), 0 40px 120px rgba(0,0,0,0.6);
...
.cs-insight {
  ...
  border-radius: 18px;
  background: linear-gradient(160deg, #08110b, #0c2018);
  position: sticky;
  top: 2rem;
...
.timeline-line {
  ...
  width: 2px;
  min-height: 44px;
  background: linear-gradient(180deg, var(--accent), rgba(22,163,74,0.15));
  margin-top: 0.25rem;
}
