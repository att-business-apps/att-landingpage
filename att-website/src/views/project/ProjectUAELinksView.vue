            ...
            <div class="breadcrumb animate__animated fadeInUp" style="animation-duration: 2s">
                ...
                <div class="section-heading heading-left">
                    <div class="d-flex align-items-center">
                        <img src="../../assets/img/project/c1/icon-uae.svg" class="m-0" style="height: 40px"
            ...
            <div class="row align-items-center">
                    ...
                    <div class="project-overview">
                        ...
                        <div class="project-details">
                            ...
                            <div class="detail-item mb-3">
                                ...
                                <p>Modern Web Technologies, Responsive Design, Government API Integration</p>
                            </div>
                            <div class="detail-item">
                                <h5 class="title">Live Website</h5>
                                <p><a href="https://uaelinks.ae" target="_blank" class="text-primary">uaelinks.ae</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="project-image">
                        <img src="../../assets/img/project/c1/project-uaeLinks.png" class="w-100 rounded"
