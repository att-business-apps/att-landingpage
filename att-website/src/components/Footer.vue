  ...
  <ul class="mobilemenu mainmenu d-lg-none d-flex">
    ...
    <li>
      <a href="/services" aria-label="what we do"
        ><span class="text-lb">Services</span></a
      >
    </li>
    <li>
    ...
    <li>
      <a href="/contact" aria-label="where to find"
        ><span class="text-lr">Contact</span></a
      >
    </li>
